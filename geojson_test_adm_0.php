    ...
    <script>
        ...
        var vectorLayer = new ol.layer.Vector({
            source: new ol.source.Vector({
                url: 'moz_adm_geo_adm0.geojson',
                format: new ol.format.GeoJSON()
            }),
            style: function(feature) {
                style.getText().setText(feature.get('NAME_FRENC'));
                return style;
            }
        });
        ...
        var featureOverlay = new ol.layer.Vector({
            ...
            map: map,
            style: function(feature) {
                highlightStyle.getText().setText(feature.get('NAME_FRENC'));
        ...
        var displayFeatureInfo = function(pixel) {
            ...
            if (feature) {
                info.innerHTML = feature.get('NAME_FRENC') + ': ' + feature.get('NAME_FRENC');
            } else {
                info.innerHTML = '&nbsp;';
            }
...
//alert(pixel);
            ...
            // var pixel = map.getEventPixel(evt.originalEvent);
            try {
                content.innerHTML = '<b>'+feature.get('NAME_FRENC') + ' / ' + feature.get('NAME_FRENC')+'</b> <code>' + hdms +
