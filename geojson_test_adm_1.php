  ...
  <div>
    ...
    center: ol.proj.fromLonLat([30.8, -18.5]),
      ...
      var featureOverlay = new ol.layer.Vector({
        ...
        map: map,
        style: function(feature) {
          highlightStyle.getText().setText(feature.get('NAME_1'));
      ...
      var displayFeatureInfo = function(pixel) {
        ...
        if (feature) {
          info.innerHTML = feature.get('NAME_0') + ': ' + feature.get('NAME_1');
        } else {
          info.innerHTML = '&nbsp;';
        }
...
//alert(pixel);
       ...
       // var pixel = map.getEventPixel(evt.originalEvent);
try {
        content.innerHTML = '<b>'+feature.get('NAME_0') + ' / ' + feature.get('NAME_1')+'</b> <code>' + hdms +
